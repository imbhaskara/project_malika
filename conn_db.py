...
def create_table():
    c.execute('CREATE TABLE IF NOT EXISTS data_idp(nik INTEGER, ambition TEXT, strength TEXT, weakness TEXT, competencies_1 TEXT, dev_type_1 TEXT, dev_desc_1 TEXT, dev_date_1 DATE, competencies_2 TEXT, dev_type_2 TEXT, dev_desc_2 TEXT, dev_date_2 DATE, competencies_3 TEXT, dev_type_3 TEXT, dev_desc_3 TEXT, dev_date_3 DATE, competencies_4 TEXT, dev_type_4 TEXT, dev_desc_4 TEXT, dev_date_4 DATE, competencies_5 TEXT, dev_type_5 TEXT, dev_desc_5 TEXT, dev_date_5 DATE, recommendation TEXT)')

def add_data(nik, ambition, strength, weakness, competencies_1, dev_type_1, dev_desc_1, dev_date_1, competencies_2, dev_type_2, dev_desc_2, dev_date_2, competencies_3, dev_type_3, dev_desc_3, dev_date_3, competencies_4, dev_type_4, dev_desc_4, dev_date_4, competencies_5, dev_type_5, dev_desc_5, dev_date_5, recommendation):
    c.execute('INSERT INTO data_idp(nik, ambition, strength, weakness, competencies_1, dev_type_1, dev_desc_1, dev_date_1, competencies_2, dev_type_2, dev_desc_2, dev_date_2, competencies_3, dev_type_3, dev_desc_3, dev_date_3, competencies_4, dev_type_4, dev_desc_4, dev_date_4, competencies_5, dev_type_5, dev_desc_5, dev_date_5, recommendation) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? )', (nik, ambition, strength, weakness, competencies_1, dev_type_1, dev_desc_1, dev_date_1, competencies_2, dev_type_2, dev_desc_2, dev_date_2, competencies_3, dev_type_3, dev_desc_3, dev_date_3, competencies_4, dev_type_4, dev_desc_4, dev_date_4, competencies_5, dev_type_5, dev_desc_5, dev_date_5, recommendation))
    conn.commit()
...
def edit_data(new_ambition, new_strength, new_weakness, new_competencies_1, new_dev_type_1, new_dev_desc_1, new_dev_date_1, new_competencies_2, new_dev_type_2, new_dev_desc_2, new_dev_date_2, new_competencies_3, new_dev_type_3, new_dev_desc_3, new_dev_date_3, new_competencies_4, new_dev_type_4, new_dev_desc_4, new_dev_date_4, new_competencies_5, new_dev_type_5, new_dev_desc_5, new_dev_date_5, new_recommendation, ambition, strength, weakness, competencies_1, dev_type_1, dev_desc_1, dev_date_1, competencies_2, dev_type_2, dev_desc_2, dev_date_2, competencies_3, dev_type_3, dev_desc_3, dev_date_3, competencies_4, dev_type_4, dev_desc_4, dev_date_4, competencies_5, dev_type_5, dev_desc_5, dev_date_5, recommendation):
    c.execute('UPDATE data_idp SET ambition=?, strength=?, weakness=?, competencies_1=?, dev_type_1=?, dev_desc_1=?, dev_date_1=?, competencies_2=?, dev_type_2=?, dev_desc_2=?, dev_date_2=?, competencies_3=?, dev_type_3=?, dev_desc_3=?, dev_date_3=?, competencies_4=?, dev_type_4=?, dev_desc_4=?, dev_date_4=?, competencies_5=?, dev_type_5=?, dev_desc_5=?, dev_date_5=?, recommendation=? where ambition=? AND strength=? AND weakness=? AND competencies_1=? AND dev_type_1=? AND dev_desc_1=? AND dev_date_1=? AND competencies_2=? AND dev_type_2=? AND dev_desc_2=? AND dev_date_2=? AND competencies_3=? AND dev_type_3=? AND dev_desc_3=? AND dev_date_3=? AND competencies_4=? AND dev_type_4=? AND dev_desc_4=? AND dev_date_4=? AND competencies_5=? AND dev_type_5=? AND dev_desc_5=? AND dev_date_5=? AND recommendation=?', (new_ambition, new_strength, new_weakness, new_competencies_1, new_dev_type_1, new_dev_desc_1, new_dev_date_1, new_competencies_2, new_dev_type_2, new_dev_desc_2, new_dev_date_2, new_competencies_3, new_dev_type_3, new_dev_desc_3, new_dev_date_3, new_competencies_4, new_dev_type_4, new_dev_desc_4, new_dev_date_4, new_competencies_5, new_dev_type_5, new_dev_desc_5, new_dev_date_5, new_recommendation, ambition, strength, weakness, competencies_1, dev_type_1, dev_desc_1, dev_date_1, competencies_2, dev_type_2, dev_desc_2, dev_date_2, competencies_3, dev_type_3, dev_desc_3, dev_date_3, competencies_4, dev_type_4, dev_desc_4, dev_date_4, competencies_5, dev_type_5, dev_desc_5, dev_date_5, recommendation))
    conn.commit()
    data = c.fetchall()
    return data
