...
def delete_plan():
    ...
    if data:
        ...
        new_ambition = st.text_area('Career Ambition in 2022', value=ambition)
        ...
        st.caption('Ceritakan maksimal 3 Jenis Development yang ingin Anda ambil di tahun 2022 untuk meningkatkan kompetensi Anda')
        ...
        new_dev_desc_1 = deskripsi_dev.text_area('Deskripsi Development yang akan dilakukan', dev_desc_1, key=1)
