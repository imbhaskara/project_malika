...
def edit_plan():
    ...
    if data:
        ...
        new_strength = strength_cols.text_area('Employee Strength', placeholder='Ceritakan tentang kompetensi yang menjadi kekuatan dari karyawan Anda', value=strength)
        new_weakness = weakness_cols.text_area('Employee Weakness', placeholder='Ceritakan tentang kompetensi yang masih kurang dari karyawan Anda', value=weakness)
        ...
        new_dev_desc_1 = deskripsi_dev1.text_area('Deskripsi Development', dev_desc_1, placeholder='Ceritakan deskripsi development apa yang ingin Anda ambil di 2022', key=1)
